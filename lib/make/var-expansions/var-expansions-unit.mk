...
COMPIL_OBJECT_CODE_UNIT = $(CXX) $(COMPILE_FLAGS) -I $(HEADER_MAIN) -I $(HEADER_UNIT) -c $< -o $@

# Linking code
UNIT_LINK_CODE = $(CXX) -I $(HEADER_MAIN) -I $(HEADER_UNIT) $(OBJECT_MAIN_FILES) $(OBJECT_UNIT_FILES) $(UNIT_MAIN_FILE) $(LINKING_FLAGS) -o $(UNIT_TARGET)
